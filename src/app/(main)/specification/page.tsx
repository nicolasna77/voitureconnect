...
const SpecificationPage = () => {
  ...
  const mutation = useMutation({
    mutationFn: (newFormState: typeof formState) => {
      ...
      console.log("Nouvelle URL:", `?${params.toString()}`);
  ...
  const updateFormState = (type: string, value: string | number) => {
    setFormState((prev) => {
      ...
      console.log("Nouvel état du formulaire:", newState);
  ...
  React.useEffect(() => {
    ...
    if (pageFromParams !== formState.page) {
      updateFormState("page", pageFromParams);
    }
  }, [searchParams]);
