...
export default function ComparePage() {
  ...
  // Track selected trim per vehicle (generationId -> trimId)
  ...
  // Get the selected trim for a vehicle (fallback to first)
  ...
  // Merge all specs (common + selected trim) for each vehicle
  ...
  // Collect all categories and spec names across vehicles
