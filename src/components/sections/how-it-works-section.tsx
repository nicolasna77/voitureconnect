...
const steps = [
  {
    ...
    description: "Recherchez par marque, modèle ou utilisez notre barre de recherche intelligente.",
  ...
  },
  {
    ...
    description: "DriveMetric croise des milliers de données issues de sources automobiles vérifiées.",
  ...
  },
  {
    ...
    description: "Fiabilité, pannes connues et juste prix : tout est là pour éviter les mauvais choix.",
  ...
  return (
    <section id="how-it-works" className="py-24 lg:py-36 bg-accent/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Reveal delay={700}>
          <div className="mx-auto mt-12 max-w-2xl rounded-2xl border border-border bg-card p-6 text-center">
