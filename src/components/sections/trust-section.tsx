...
const trustPoints = [
  { icon: Shield,       title: "Système intelligent", text: "Analyse automatisée de milliers de points de données par véhicule" },
  { icon: Database,     title: "Sources vérifiées",   text: "Uniquement des bases de données automobiles reconnues et contrôlées" },
  { icon: CheckCircle2, title: "Zéro forum douteux",  text: "Aucun avis non vérifié, que des informations factuelles et traçables" },
  { icon: Lock,         title: "Données réelles",     text: "Chaque information est vérifiable et sourcée, rien n'est inventé" },
];
                ...
                <div className="mt-12 grid gap-4 sm:grid-cols-2">
                  {trustPoints.map((point, i) => (
                    <Reveal key={point.title} delay={300 + i * 100}>
                      <div className="group flex items-start gap-4 rounded-xl border border-border bg-background/50 p-5 text-left transition-all duration-300 hover:bg-background/80">
                        ...
                        <div>
                          <span className="font-semibold text-card-foreground">{point.title}</span>
